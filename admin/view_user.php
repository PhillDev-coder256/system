                ...
                <div class="container-fluid">
                    ...
                    <div class="income">
                        ...
                        <table class="table table-bordered">
                            <thead class="thead-dark">
                                <tr style="background:red">
                                    <th class="text-danger" colspan="7">
                                        ADMINS
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($database, $adminsql);
                                ...
                                ?>
                                <tr>
                                    <td class="text-danger"><?php echo $rowno; ?></td>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            <a href="?action=view&email='.$email.'&error=0" class="non-style-link"><button  class="btn-primary-soft btn btn-info button-icon btn-edit"  ><i class="fa fa-info"></i>&nbsp &nbsp<font  class="tn-in-text">View</font></button></a>
                                            &nbsp;&nbsp;&nbsp;
                                            </div>
                                            ';
                                        ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($database, $usersql);
                                    while($row = mysqli_fetch_array($result)){
                                        // $id = $row['id'];
                                        $email = $row['uemail'];
                                        $rowno2 = $rowno2 + 1;
                                ?>
                                <tr>
                                    <td class="text-danger"><?php echo $rowno2; ?></td>
    ...
    if($action=='drop'){
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="view_user.php">&times;</a>
                        <div class="content">
                            You want to delete a user record with ID ('.substr($id,0,40).')?  <br>('.substr($emailget,0,40).')
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete_user.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="view_user.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
        ...
        $sqlmain= "select * from user where uemail='$email'";
                    ...
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="id" style="font-weight:bold ;font-size:20px" class="form-label">USER EMAIL: </label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class=" label-td" colspan="2">
                                <label for="Email" style="font-weight:bold; font-size:20px" class="form-label">USER NAME: </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-primary label-td" colspan="2">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="nic" style="font-weight:bold ;font-size:20px" class="form-label">CONTACT: </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-primary label-td" colspan="2">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="Tele" style="font-weight:bold ;font-size:20px" class="form-label">CREATED BY: </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-primary label-td" colspan="2">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="spec" style="font-weight:bold ;font-size:20px" class="form-label">DATE CREATED: </label>
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="view_user.php"><input type="button" value="Close" class="btn-warning login-btn btn-primary-soft btn" ></a>
        ...
        $sqlmain= "select * from user where id='$id'";
        $result= $database->query($sqlmain);
        $row=$result->fetch_assoc();
        $email=$row["useremail"];
        $amount=$row["amount"];
        ...
        fetch('update_total_income.php')
            ...
            .then(data => {
                if (data.total_income !== undefined) {
                    ...
                    document.getElementById('totalIncomeAmount').textContent = data.total_income;
