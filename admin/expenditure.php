...
<body id="page-top">
    <?php
        ...
        $expendituresql= "select * from expenditure";
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        $id = $row['id'];
                                        $email = $row['useremail'];
                                        // $fetch_name = "select uname from user where uemail = '$email'";
                                        //     $result = mysqli_query($database, $fetch_name);
                                        //     while($row = mysqli_fetch_array($result)){
                                        //         $name = $row['uname'];
                                        //     }
        ...
        fetch('update_total_expenditure.php')
            ...
            .then(data => {
                if (data.total_expenditure !== undefined) {
                    ...
                    document.getElementById('totalExpenditureAmount').textContent = number_format(data.total_expenditure, 1);
