...
<body id="page-top">
    <?php
        ...
        $paid_loansql= "select * from paid_loan";
        ...
        if($_POST['save']){
            ...
            $sql = "INSERT INTO paid_loan(amount, comment, useremail)VALUES('$amount', '$comment', '$useremail')";

            $query = mysqli_query($database, $sql);

            if ($query) {
                echo "<script>alert('NEW paid_loan RECORD ADDED SUCCESSFULLY')</script>";
            
                // Call the function to update the total amount
                echo "<script>updateTotalPaidLoan();</script>";
            }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Paid Loan &nbsp &nbsp <button class="btn btn-sm btn-info">UGX.<span id="totalPaidLoanAmount"></span> </button></h1>
    ...
    <!-- Delete paid_loan Modal-->
    <div class="modal fade" id="deleteDeletedLoanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to delete paid_loan?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Delete" below if you are ready to delete your paid_loan.</div>
                <div class="modal-footer">
     ...
     <!-- Edit paid_loan Modal-->
     <div class="modal fade" id="editpaidLoanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to Edit paid_loan details?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Edit" below if you are ready to edit paid_loan details.</div>
                <div class="modal-footer">
        ...
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            You want to delete a paid_loan record with ID ('.substr($id,0,40).')?  <br>('.substr($emailget,0,40).')
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete_paid_loan.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="paid_loan.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <label for="nic" style="font-weight:bold ;font-size:20px" class="form-label">Date paid: </label>
                            </td>
                        </tr>
                        <tr>
                            <td class="text-primary label-td" colspan="2">
                        ...
                        <div class="popup">
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    paid_loan ID : '.$id.' (Auto Generated)<br><br> 
                                    Email : '.$email.' (Auto Generated)<br><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <form action="edit_paid_loan.php" method="POST">
        ...
        fetch('update_total_paid_loan.php')
            ...
            .then(data => {
                if (data.total_paid_loan !== undefined) {
                    ...
                    document.getElementById('totalPaidLoanAmount').textContent = number_format(data.total_paid_loan, 1);
