...
<body id="page-top">
    <?php
        ...
        $loansql= "select * from loan where useremail = '$useremail'";
        ...
        if($_POST['save']){
            ...
            $sql = "INSERT INTO loan(amount, comment, useremail)VALUES('$amount', '$comment', '$useremail')";
            ...
            if ($query) {
                echo "<script>alert('NEW LOAN RECORD ADDED SUCCESSFULLY')</script>";
            
                // Call the function to update the total amount
                echo "<script>updateTotalLoan();</script>";
            }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Loan &nbsp &nbsp <button class="btn btn-sm btn-info">UGX.<span id="totalLoanAmount"></span> </button></h1>
                        <a href="paid_loan.php" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i
                                class="fas fa-check fa-sm text-white-50"></i> View Paid Loans</a>
                    ...
                    <div class="income">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($database, $loansql);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="?action=pay&id='.$id.'" class="non-style-link"><button  class="btn btn-primary button-icon btn-view"  style=""><i class="fa fa-check"></i>&nbsp &nbsp<font class="tn-in-text">Pay</font></button></a>
                                           &nbsp;&nbsp;&nbsp;
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     ...
     <!-- Pay Loan Modal-->
     <div class="modal fade" id="payLoanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to Pay Loan?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Pay" below if you are ready to pay your loan.</div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="deleteLoanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Select "Delete" below if you are ready to delete your loan.</div>
                <div class="modal-footer">
                    <button class="btn btn-success" type="button" data-dismiss="modal">Cancel</button>
                    <?php
                        $result = mysqli_query($database, $loansql);
     ...
     <!-- Edit Loan Modal-->
     <div class="modal fade" id="editLoanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to Edit Loan details?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Edit" below if you are ready to edit loan details.</div>
                <div class="modal-footer">
...
if($_GET){
    ...
    if($action=='drop'){
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="loans.php">&times;</a>
                        <div class="content">
                            You want to delete a loan record with ID ('.substr($id,0,40).')?  <br>('.substr($emailget,0,40).')
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete_loan.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="loans.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="loans.php"><input type="button" value="Close" class="btn-warning login-btn btn-primary-soft btn" ></a>
        ...
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="loans.php">&times;</a>
                        <div class="content">
                            You want to <b ="text-warning">pay</b> a loan record with ID ('.substr($id,0,40).') ?
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="pay_loan.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="loans.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
    ...
    function updateTotalLoan() {
        ...
        fetch('update_total_loan.php')
            .then(response => response.json())
            .then(data => {
                if (data.total_loan !== undefined) {
                    // Update the displayed total amount
                    document.getElementById('totalLoanAmount').textContent = number_format(data.total_loan, 2);
                    // $_SESSION['total_loan'] = data.total_loan;
                    // $paid = $_SESSION['total_paid_loan'];
                } else {
                    console.error('Error updating total loan amount:', data.error);
                }
            })
            .catch(error => {
    ...
    function updateTotalPaidLoan(){
        ...
        .then(data => {
            if (data.total_paid_loan !== undefined) {
                // Update the displayed total amount
                document.getElementById('totalPaidLoanAmount').textContent = 767898;
                // document.getElementById('totalPaidLoanAmount').textContent = data.total_paid_loan;
