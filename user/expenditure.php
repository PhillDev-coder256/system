...
<body id="page-top">
    <?php
        ...
        $expendituresql= "select * from expenditure where useremail = '$useremail'";
        ...
        if($_POST['save']){
            ...
            if($amount > $_SESSION['available_amount']){
                    echo "<script>alert('YOUR EXPENDITURE CANNOT EXCEED YOUR CURRENT AVAILABLE AMOUNT. ')</script>";

                }else{
                    $sql = "INSERT INTO expenditure(amount, comment, useremail)VALUES('$amount', '$comment', '$useremail')";

                    $query = mysqli_query($database, $sql);

                    if ($query) {
                        echo "<script>alert('NEW EXPENDITURE RECORD ADDED SUCCESSFULLY')</script>";
                    
                        // Call the function to update the total amount
                        echo "<script>updateTotalExpenditure();</script>";
                    }
                }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Expenditure &nbsp &nbsp <button class="btn btn-sm btn-info">UGX.<span id="totalExpenditureAmount"></span> </button></h1>
                    ...
                    <div class="income">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($database, $expendituresql);
    ...
    <div class="modal fade" id="deleteExpenditureModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to delete Expenditure?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Delete" below if you are ready to delete your Expenditure.</div>
                <div class="modal-footer">
     ...
     <div class="modal fade" id="editExpenditureModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to Edit Expenditure details?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Edit" below if you are ready to edit Expenditure details.</div>
                <div class="modal-footer">
...
if($_GET){
    ...
    if($action=='drop'){
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="expenditure.php">&times;</a>
                        <div class="content">
                            You want to delete a expenditure record with ID ('.substr($id,0,40).')?  <br>('.substr($emailget,0,40).')
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete_expenditure.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="expenditure.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="expenditure.php"><input type="button" value="Close" class="btn-warning login-btn btn-primary-soft btn" ></a>
                        ...
                        <div class="popup">
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    expenditure ID : '.$id.' (Auto Generated)<br><br> 
                                    Email : '.$email.' (Auto Generated)<br><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <form action="edit_expenditure.php" method="POST">
    ...
    function updateTotalExpenditure() {
        ...
        fetch('update_total_expenditure.php')
            .then(response => response.json())
            .then(data => {
                if (data.total_exapenditure !== undefined) {
                    // Update the displayed total amount
                    document.getElementById('totalExpenditureAmount').textContent = number_format(data.total_expenditure);
                    // $_SESSION['total_expenditure'] = data.total_expenditure;
                } else {
                    console.error('Error updating total expenditure amount:', data.error);
                }
            })
            .catch(error => {
