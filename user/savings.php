...
<body id="page-top">
    <?php
        ...
        $savingsql= "select * from saving where useremail = '$useremail'";
        ...
        if($_POST['save']){
            ...
            if($amount <= $_SESSION['available_amount']){
                $sql = "INSERT INTO saving(amount, comment, useremail)VALUES('$amount', '$comment', '$useremail')";

                $query = mysqli_query($database, $sql);

                if ($query) {
                    echo "<script>alert('NEW SAVING RECORD ADDED SUCCESSFULLY')</script>";
                
                    // Call the function to update the total amount
                    echo "<script>updateTotalSaving();</script>";
                }
            }else{
                echo "<script>alert('You cannot save beyond the available amount')</script>";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Saving &nbsp &nbsp <button class="btn btn-sm btn-info">UGX.<span id="totalSavingAmount"></span> </button></h1>
                    ...
                    <div class="income">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($database, $savingsql);
    ...
    <!-- Delete Saving Modal-->
    <div class="modal fade" id="deleteSavingModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to delete Saving?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Delete" below if you are ready to delete your Saving.</div>
                <div class="modal-footer">
     ...
     <!-- Edit aving Modal-->
     <div class="modal fade" id="editSavingModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to Edit Saving details?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Edit" below if you are ready to edit Saving details.</div>
                <div class="modal-footer">
...
if($_GET){
    ...
    if($action=='drop'){
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="savings.php">&times;</a>
                        <div class="content">
                            You want to delete a saving record with ID ('.substr($id,0,40).')?  <br>('.substr($emailget,0,40).')
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete_saving.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="savings.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="savings.php"><input type="button" value="Close" class="btn-warning login-btn btn-primary-soft btn" ></a>
                        ...
                        <div class="popup">
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    saving ID : '.$id.' (Auto Generated)<br><br> 
                                    Email : '.$email.' (Auto Generated)<br><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <form action="edit_saving.php" method="POST">
    ...
    function updateTotalSaving() {
        ...
        fetch('update_total_saving.php')
            .then(response => response.json())
            .then(data => {
                if (data.total_saving !== undefined) {
                    // Update the displayed total amount
                    document.getElementById('totalSavingAmount').textContent = number_format(data.total_saving, 2);
                    // $_SESSION['total_saving'] = data.total_saving;
                } else {
                    console.error('Error updating total saving amount:', data.error);
                }
            })
            .catch(error => {
