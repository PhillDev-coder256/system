...
<body id="page-top">
    <?php
        ...
        $incomesql= "select * from income where useremail = '$useremail'";
        
        if($_POST['save']){
            
            $amount = $_POST['amount'];
            $comment = $_POST['comment'];
            $_SESSION['current_amount'] = $amount;

            $sql = "INSERT INTO income(amount, comment, useremail)VALUES('$amount', '$comment', '$useremail')";

            $query = mysqli_query($database, $sql);

            if ($query) {
                echo "<script>alert('NEW INCOME RECORD ADDED SUCCESSFULLY')</script>";
            
                // Call the function to update the total amount
                echo "<script>updateTotalIncome();</script>";
            }
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800">Income &nbsp &nbsp <button class="btn btn-sm btn-info">UGX.<span id="totalIncomeAmount"></span> </button></h1>
                    ...
                    <div class="income">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    $result = mysqli_query($database, $incomesql);
    ...
    <!-- Delete income Modal-->
    <div class="modal fade" id="deleteIncomeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to delete Income?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Delete" below if you are ready to delete your Income.</div>
                <div class="modal-footer">
     ...
     <!-- Edit income Modal-->
     <div class="modal fade" id="editIncomeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ready to Edit Income details?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Select "Edit" below if you are ready to edit Income details.</div>
                <div class="modal-footer">
...
if($_GET){
    ...
    if($action=='drop'){
        $emailget=$_GET["useremail"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        <h2>Are you sure?</h2>
                        <a class="close" href="income.php">&times;</a>
                        <div class="content">
                            You want to delete a income record with ID ('.substr($id,0,40).')?  <br>('.substr($emailget,0,40).')
                            
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete_income.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="income.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    ...
                    <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="income.php"><input type="button" value="Close" class="btn-warning login-btn btn-primary-soft btn" ></a>
                        ...
                        <div class="popup">
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    income ID : '.$id.' (Auto Generated)<br><br> 
    ...
    function updateTotalIncome() {
        ...
        fetch('update_total_income.php')
            .then(response => response.json())
            .then(data => {
                if (data.total_income !== undefined) {
                    // Update the displayed total amount
                    document.getElementById('totalIncomeAmount').textContent = number_format(data.total_income, 0);
                    // $_SESSION['total_income'] = data.total_income;
                } else {
                    console.error('Error updating total income amount:', data.error);
                }
            })
            .catch(error => {
